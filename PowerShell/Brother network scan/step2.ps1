...
Create-LocalUser -computer $env:COMPUTERNAME -fullname 'Skaner Brother' -username 'brother-scan' -password 'brother' -passworddoesnotexpire -addtogroup 'Użytkownicy'
mkdir -Path C:\Skany -Force
New-SmbShare -Name Skany -Path C:\Skany -Description "Zasób ze skanami z urządzenia Brother" -FullAccess Wszyscy